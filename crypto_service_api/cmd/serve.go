...
import (
	"github.com/obarbier/awesome-crypto/crypto_service_api/adapters"
	"github.com/obarbier/awesome-crypto/crypto_service_api/domain"
	"github.com/obarbier/awesome-crypto/crypto_service_api/handler"
...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = http.ListenAndServe("localhost:2022", handler.Handler(handlerProps))
		if err != nil {
			return
		}
